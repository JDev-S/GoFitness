                   ...
                   $paginacion=ceil($paginacion); 
                    if($pagina==1)
                    {
                       echo '<meta name="robots" content="index, follow" />';
                        echo'<link rel="next" href="/videos_rutinas/'.($pagina+1).'">';
                    }
                    else
                    {
                        ...
                        if($pagina>$paginacion)
                       {
                           ...
                           echo'<link rel="prev" href="/videos_rutinas/'.$paginacion.'">';
                       }
                       else
                       {
                           
                           echo'<link rel="prev" href="/videos_rutinas/'.($pagina-1).'">';
                       }
                    }
...
<div id="main">
                	...
                	<div class="container">
                        ...
                        <section id="primary" class="page-with-sidebar page-with-left-sidebar">
                            <div class="dt-sc-sorting-container">
                                <a class="first active-sort" data-filter="*" href="/rutinas">Todas las categorias</a>
                            ...
                            <div class="dt-sc-portfolio-container isotope" style="position: relative; overflow: hidden; height: 3152px;">
                                ...
                                @foreach($videos_rutinas as $videos)
                                ...
                                <div class="portfolio-detail">
                                    <div class="portfolio-title">
                                        <h4><a href='/clases?buscar={{$videos->id_rutina}}'>{{$videos->nombre_video}}</a></h4>
               ...
               <ul class="pagination">
                   ...
                   if($pagina>1)
                   {
                       if($pagina>$paginacion)
                       {
                           echo'<li><a href="/videos_rutinas/'.$paginacion.'">«</a></li>';
                       }
                       else
                       {
                           echo'<li><a href="/videos_rutinas/'.($pagina-1).'">«</a></li>';
                       }
                   ...
                   for($i=1;$i<=ceil($numero_videos[0]->numero_videos/15);$i++)
                   {
                       if($i==$pagina)
                       {
                           echo'<li class="active"><a  href="/videos_rutinas/'.$i.'">'.$i.'</a></li>';
                           
                       }
                       else
                       {
                           echo'<li><a  href="/videos_rutinas/'.$i.'">'.$i.'</a></li>';
                       }
